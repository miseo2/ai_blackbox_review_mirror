# 250515
발표 흐름 및 사고 유형 파악 흐름을 정리했음. 시연도 대략적으로 기획 마무리 하고 있음

# 250514
- 기획 배경 ppt 1차 완료
- 인터뷰 대상 리스트업 후 메일 + 상담일자 확정.

# 250513
기획 배경 ppt 마무리 단계
- 분쟁심의위원회를 기대효과 부분으로 빼버릴 것
- 흐름이 자연스럽게 이어지도록 연결 부분 고민을 좀 더 해볼 것

# 250512
기획 배경 ppt 작성 중
- 현재: 과실 비율 판단 기준이 심의위원회와 같음 -> 사고 발생 - 협의 - 소송 단계에서 사고 발생 - AI블리 - 협의 단계로 줄여줄게 에 초점
- 수정 방향: 사용자가 복잡하지 않고, 간단하게 과실 비율 판단을 할 수 있다는 것을 보여주자. 과실 비율 판단이라는 무거운 내용을 중간중간에만 넣어주고 사용자 흐름이 간단하다는 것에 집중시키기. usb뽑고 - 노트북에 꼽고, 업로드 하고.. 이런 과정을 없애줄게! 우리꺼 다운만 받아라! 를 보여주기

- 컨설턴트 님과의 면담
- 수요일 오전에 완성하는 것으로 팀 미팅 정리.
